...
void spriteColorBlendDraw(Sprite_M* sprite, SDL_Renderer* renderer, int frame, Vector2D position);
void spriteDrawNoBlend(Sprite_M* sprite, SDL_Renderer* renderer, int frame, Vector2D position);
